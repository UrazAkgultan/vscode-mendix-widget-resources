...
export const folderIcons: FolderIconType[] = [
    {
        name: "mx",
        folderNames: ["mx"]
    },
    ...
    {
        name: "folder-theme",
        folderNames: ["themes", "theme", "color", "colors", "design", "designs", "themesource"]
    },
    ...
    {
        name: "folder-mobile",
        folderNames: ["mobile", "mobiles", "portable", "portability", "native"]
    },
